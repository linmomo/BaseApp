...
public class ViewUtils {
	 ...
	 */
	public static LinearLayout createLinearLayout(Context context,
			int orientation, int width, int height, int weight) {
		LinearLayout linearLayout = new LinearLayout(context);
		linearLayout.setOrientation(orientation);
		linearLayout.setLayoutParams(new LinearLayout.LayoutParams(width,
				height, weight));
	 ...
	 */
	public static void setListViewHeightByAllChildrenViewHeight(
			ListView listView) {
	 ...
	 * 设置流布局的底部外边距
	 */
	public static void setLinearLayoutBottomMargin(LinearLayout linearLayout,
			int newBottomMargin) {
		LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) linearLayout
				.getLayoutParams();
	...
	public static final void setEditTextSelectionToEnd(EditText editText) {
		...
		Selection.setSelection((Spannable) editable, editable.toString()
				.length());
	}
